  ...
  {{-- Service --}}
    ...
    <section class="section">
        <div class="container">
            ...
            <p class="mb-3" style="color: #000080; font-size: 2.5rem; font-weight: bold;">Our Services</p>
...
<section class="section">
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 mb-5">
                    <div class="section-title pt-4">
            <p class="mb-3" style="color: #000080; font-size: 2.5rem; font-weight: bold;">Our Blog</p>
 ...
 <section class="section">
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 mb-5">
                    <div class="section-title pt-4">
            <p class="mb-3" style="color: #000080; font-size: 2.5rem; font-weight: bold;">Our Team</p>
