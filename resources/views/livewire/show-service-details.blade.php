        ...
        <div class="row g-5">
            <div class="col-lg-8 mx-auto">
                <div class="block p-4 border rounded shadow-sm h-100">
                    ...
                    <!-- Title -->
                    <h2 class="mb-3 text-center" style="color: navy;">{{ $service->title }}</h2>

                    <!-- Short Description -->
                    <p class="text-center mb-4">{{ $service->short_desc }}</p>

                    <!-- Video -->
                    @if ($service->video_path)
                     <div class="mb-4">
                       <div class="ratio ratio-16x9 rounded shadow-sm border" style="overflow: hidden;">
