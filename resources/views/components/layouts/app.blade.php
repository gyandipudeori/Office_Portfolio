...
<header class="navigation bg-tertiary">
	<nav class="navbar navbar-expand-xl navbar-light py-3" style="background-color: #ffffff;">
		<div class="container">
			<!-- Logo on the left -->
			<a class="navbar-brand" wire:navigate href="{{ route('home')}}">
				<img loading="preload" decoding="async" class="img-fluid" width="160" src="front/images/funklogo.png" alt="Funked Media">
			</a>
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav ms-auto mb-2 mb-lg-0">
					<li class="nav-item"><a wire:navigate class="nav-link" style="color: #000080;" href="{{ route('home')}}">Home</a></li>
					<li class="nav-item"><a wire:navigate class="nav-link" style="color: #000080;" href="{{ route("page",1)}}">About Us</a></li>
					<li class="nav-item"><a wire:navigate class="nav-link" style="color: #000080;" href="{{ route('servicesPage')}}">Services</a></li>
					<li class="nav-item"><a wire:navigate class="nav-link" style="color: #000080;" href="{{ route('blog')}}">Blog</a></li>
					<li class="nav-item"><a wire:navigate class="nav-link" style="color: #000080;" href="{{ route('teamPage')}}">Our Team</a></li>
					<li class="nav-item"><a wire:navigate class="nav-link" style="color: #000080;" href="{{route('contact')}}">Contact Us</a></li>
				</ul>
			</div>
		</div>
	</nav>
