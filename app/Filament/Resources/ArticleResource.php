    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                ...
                TextInput::make('youtube_url')->url()->label('Youtube URL')->placeholder('Enter your youtube link'),
                TextInput::make('spotify_url')->url()->label('Spotify URL')->placeholder('Enter your spotify link'),
